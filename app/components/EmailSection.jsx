        ...
        <div>
            <form className='flex flex-col ' onSubmit={handleSubmit}>
                <div className='mb-6'>
                    ...
                    <input name='email' type="email" id='email' required className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5' placeholder='hiwot@gmail.com' />
                </div>
                <div className='mb-6'>
